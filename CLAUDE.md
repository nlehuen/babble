...
- **Grammar** (`src/main/antlr4/.../Babble.g4`): ~90 lines defining the whole language. Everything is an `expression` (no statements); labeled alternatives (`# defExpression`, `# call`, etc.) become the visitor methods. Visitor generation is on, listener off.
